...
function AboutMe() {
    return (
        <div className="aboutMe">
            ...
            <section className="card-text about-me">
                <p className="card-text">As a licensed and certified pharmacy technician for the last 9 years, I always thought that I
                would
                ...
                exposed to most things development such as:
                        ...
                        While having the exposure to all of these, I decided to further my education and grow in
                        development
                ...
                your
                audience. I am capable of designing websites with a focus on mobile-first design that
                engages
                the
                ...
                <p>My husband has always told me <b>"If you love what you do, you will never work a day in your
                                life!"</b>
                            This is my motivation and why I have chosen to pursue Web Design!!</p>
            </section>
        </div>
    )
};
