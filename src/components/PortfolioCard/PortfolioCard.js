                ...
                <div className="col mb-4">
                    <div className="card">
                        {/* <a href="https://github.com/jpino7/TasksForLaughs" target="_blank"><img src="Images/LaughyTasky.png"
                                title="Laughy Tasky Repo" className="card-img-top" alt="Project One Task App"></a> */}
                        <div className="card-body">
                            {/* <a className="card-title" href="https://jpino7.github.io/TasksForLaughs/" target="_blank">Laughy Tasky</a> */}
                ...
                <div className="col mb-4">
                    <div className="card">
                        {/* <a href="https://github.com/jpino7/Weather-Dashboard" target="_blank"><img src="Images/WeatherorNot.png"
                                    title="Weather or Not Repo" className="card-img-top" alt="Weather or Not App"></a> */}
                        <div className="card-body">
                            {/* <a className="card-title" href="https://jpino7.github.io/Weather-Dashboard/" target="_blank">Weather or Not!</a> */}
                ...
                <div className="col mb-4">
                    <div className="card">
                        {/* <a href="https://github.com/jpino7/Code-Quiz" target="_blank"><img src="Images/CodeQuiz.png"
                                        title="Code Quiz Repo" className="card-img-top" alt="Code Quiz App"></a> */}
                        <div className="card-body">
                            {/* <a className="card-title" href="https://jpino7.github.io/Code-Quiz/" target="_blank">Code Quiz</a> */}
                ...
                <div className="col mb-4">
                    <div className="card">
                        {/* <a href="https://github.com/jpino7/TeamGenerator" target="_blank"><img src="Images/TeamGenerator.png"
                                            title="Team Generator Repo" className="card-img-top" alt="Team Generator App"></a> */}
                        <div className="card-body">
                            {/* <a className="card-title" href="https://github.com/jpino7/TeamGenerator/tree/master/output">Team Generator
                ...
                <div className="col mb-4">
                    <div className="card">
                        {/* <a href="https://github.com/jpino7/READMEgenerator" target="_blank"><img src="Images/Demo.gif.gif"
                                title="READMEGenerator Repo" className="card-img-top" alt="README Generator App" /></a> */}
                        <div className="card-body">
                ...
                <div className="col mb-4">
                    <div className="card">
                        {/* <a href="https://github.com/jpino7/Burger" target="_blank"><img src="Images/Eat Da Burger UI.png"
                                    title="Eat Da Burger! Repo" className="card-img-top" alt="Eat Da Burger App"></a> */}
                        <div className="card-body">
                            {/* <a className="card-title" href="https://shielded-inlet-96490.herokuapp.com/" target="_blank">Eat Da Burger!</a> */}
                ...
                <div className="col mb-4">
                    <div className="card">
                        {/* <a href="https://github.com/lvarnum/Lead-Astray" target="_blank"><img src="Images/LeadAstray.png"
                                        title="Lead Astray Repo" className="card-img-top" alt="Lead Astray App"></a> */}
                        <div className="card-body">
                            {/* <a className="card-title" href="https://frozen-crag-01668.herokuapp.com/" target="_blank">Lead Astray</a> */}
                ...
                <div className="col mb-4">
                    <div className="card">
                        {/* <iframe src="https://giphy.com/embed/LnERKvSzDWHIcA0oMv" width="200" height="200" frameBorder="0"
                                            className="giphy-comingsoon"></iframe> */}
                        <div className="card-body">
                            {/* <a className="card-title" href="#">Future Project</a> */}
                            <p className="card-text">A work in progress, stay tuned!</p>
                        </div>
                    </div>
                </div>
            </div>
